...
<style>
    ...
    /* Hero Header Banner */
    .hero-banner {
        background: linear-gradient(135deg, #003DA5 0%, #0052CC 60%, #003DA5 100%);
        padding: 40px 36px 32px 36px;
        border-radius: 18px;
        margin-bottom: 28px;
        box-shadow: 0 8px 32px rgba(0, 61, 165, 0.25);
        text-align: center;
        position: relative;
        overflow: hidden;
    }
    ...
    .stButton > button {
        ...
        box-shadow: 0 4px 16px rgba(0, 61, 165, 0.30) !important;
    ...
    section[data-testid="stSidebar"] {
        background: linear-gradient(180deg, #002B7A 0%, #003DA5 100%) !important;
    }
    section[data-testid="stSidebar"] * {
        color: #fff !important;
    }
...
<div class="hero-banner">
    ...
    <p class="hero-subtitle">Help us plan ahead — let us know if you'd like <span class="hero-accent">food</span> at the meeting!</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown('''
<div class="info-card">
    <p>🔒 Your information is stored securely and only accessible by the meeting administrator.</p>
</div>
''', unsafe_allow_html=True)
